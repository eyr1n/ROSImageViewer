...
namespace sensor_msgs {
    namespace msg {
        ...
        BatteryStatePubSubType::BatteryStatePubSubType()
        {
            ...
            auto type_size = BatteryState::getMaxCdrSerializedSize();
            type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
            m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
            m_isGetKeyDefined = BatteryState::isKeyDefined();
            size_t keyLength = BatteryState::getKeyMaxCdrSerializedSize() > 16 ?
                    BatteryState::getKeyMaxCdrSerializedSize() : 16;
        ...
        bool BatteryStatePubSubType::serialize(
                void* data,
        ...
        bool BatteryStatePubSubType::deserialize(
                SerializedPayload_t* payload,
                void* data)
        {
            try
        ...
        std::function<uint32_t()> BatteryStatePubSubType::getSerializedSizeProvider(
                void* data)
        {
            return [data]() -> uint32_t
                   {
                       return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<BatteryState*>(data))) +
                              4u /*encapsulation*/;
                   };
        }
        ...
        void BatteryStatePubSubType::deleteData(
                void* data)
        {
            delete(reinterpret_cast<BatteryState*>(data));
        }

        bool BatteryStatePubSubType::getKey(
                void* data,
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    BatteryState::getKeyMaxCdrSerializedSize());
