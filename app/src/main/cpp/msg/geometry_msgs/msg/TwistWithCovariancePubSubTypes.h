...
namespace geometry_msgs
{
    namespace msg
    {
        ...
        namespace detail {
            ...
            {
                typedef geometry_msgs::msg::double__36 TwistWithCovariance::* type;
        ...
        public:
            ...
            eProsima_user_DllExport virtual ~TwistWithCovariancePubSubType() override;
        ...
        private:
            ...
            {
                return 336ULL == (detail::TwistWithCovariance_offset_of<TwistWithCovariance, detail::TwistWithCovariance_f>() + sizeof(geometry_msgs::msg::double__36));
