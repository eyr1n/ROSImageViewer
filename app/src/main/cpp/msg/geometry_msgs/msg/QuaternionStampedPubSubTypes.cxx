...
namespace geometry_msgs {
    namespace msg {
        QuaternionStampedPubSubType::QuaternionStampedPubSubType()
        {
            ...
            auto type_size = QuaternionStamped::getMaxCdrSerializedSize();
            type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
            m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
            m_isGetKeyDefined = QuaternionStamped::isKeyDefined();
            size_t keyLength = QuaternionStamped::getKeyMaxCdrSerializedSize() > 16 ?
                    QuaternionStamped::getKeyMaxCdrSerializedSize() : 16;
                ...
                void* data)
        {
            return [data]() -> uint32_t
                   {
                       return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<QuaternionStamped*>(data))) +
                              4u /*encapsulation*/;
                   };
        }
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    QuaternionStamped::getKeyMaxCdrSerializedSize());

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            p_type->serializeKey(ser);
            if (force_md5 || QuaternionStamped::getKeyMaxCdrSerializedSize() > 16)
            {
                m_md5.init();
