...
#define std_msgs_msg_UInt8MultiArray_max_cdr_typesize 26912ULL;
...
#define std_msgs_msg_UInt8MultiArray_max_key_cdr_typesize 0ULL;
...
std_msgs::msg::UInt8MultiArray& std_msgs::msg::UInt8MultiArray::operator =(
        const UInt8MultiArray& x)
{
...
bool std_msgs::msg::UInt8MultiArray::operator ==(
...
size_t std_msgs::msg::UInt8MultiArray::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return std_msgs_msg_UInt8MultiArray_max_cdr_typesize;
}

size_t std_msgs::msg::UInt8MultiArray::getCdrSerializedSize(
        const std_msgs::msg::UInt8MultiArray& data,
        size_t current_alignment)
{
    (void)data;
...
void std_msgs::msg::UInt8MultiArray::serialize(
...
void std_msgs::msg::UInt8MultiArray::deserialize(
 ...
 */
void std_msgs::msg::UInt8MultiArray::layout(
 ...
 */
const std_msgs::msg::MultiArrayLayout& std_msgs::msg::UInt8MultiArray::layout() const
{
    return m_layout;
}
 ...
 */
std_msgs::msg::MultiArrayLayout& std_msgs::msg::UInt8MultiArray::layout()
{
    return m_layout;
}
/*!
 ...
 */
void std_msgs::msg::UInt8MultiArray::data(
 ...
 */
const std::vector<uint8_t>& std_msgs::msg::UInt8MultiArray::data() const
{
    return m_data;
}
 ...
 */
std::vector<uint8_t>& std_msgs::msg::UInt8MultiArray::data()
{
    return m_data;
}


size_t std_msgs::msg::UInt8MultiArray::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return std_msgs_msg_UInt8MultiArray_max_key_cdr_typesize;
}

bool std_msgs::msg::UInt8MultiArray::isKeyDefined()
{
    return false;
}

void std_msgs::msg::UInt8MultiArray::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
